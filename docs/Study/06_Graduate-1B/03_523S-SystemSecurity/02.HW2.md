...
## 3. What is the return address of the vulnerable function?
...
### a. If successful, you should get a shell. Can you say why?
...
###  b. Exit the shell; what do you see? Why?
...
## 5. Exploit the program to spawn a new shell using a shellcode
